...
def draw_board():
    ...
    block28 = Tile(WHITE, 150+VERTICAL_TILE_SIZE_X*8, ((HEIGHT - VERTICAL_TILE_SIZE_Y) + 36), "MUMBAI", 5000)
    block28.draw_down_small_tile()
    block29 = Tile(WHITE, 150+VERTICAL_TILE_SIZE_X*9, ((HEIGHT - VERTICAL_TILE_SIZE_Y) + 36), "DELHI", 5000)
    block29.draw_down_small_tile()
    block30 = Tile(WHITE, 150+VERTICAL_TILE_SIZE_X*10, ((HEIGHT - VERTICAL_TILE_SIZE_Y) + 36), "AHMEDABAD", 5000)
    block30.draw_down_small_tile()
    block31 = Tile(WHITE, 150+VERTICAL_TILE_SIZE_X*11, ((HEIGHT - VERTICAL_TILE_SIZE_Y) + 36), "JAKARTA", 5000)
    block31.draw_down_small_tile()
    block32 = Tile(WHITE, 150+VERTICAL_TILE_SIZE_X*12, ((HEIGHT - VERTICAL_TILE_SIZE_Y) + 36), "BANDUNG", 5000)
    block32.draw_down_small_tile()

    #left tile
    block33 = Tile(WHITE, 0, 150, "BANGKOK", 5000)
    block33.draw_left_small_tile()
    block34 = Tile(WHITE, 0, 150+HORIZONTAL_TILE_SIZE_X*1, "HO CHI MINH CITY", 5000)
    block34.draw_left_small_tile()
    block35 = Tile(WHITE, 0, 150+HORIZONTAL_TILE_SIZE_X*2, "HA NOI", 5000)
    block35.draw_left_small_tile()
    block36 = Tile(WHITE, 0, 150+HORIZONTAL_TILE_SIZE_X*3, "CHANCE", 5000)
    block36.draw_left_small_tile()
    block37 = Tile(WHITE, 0, 150+HORIZONTAL_TILE_SIZE_X*4, "BUSAN", 5000)
    block37.draw_left_small_tile()
    block38 = Tile(WHITE, 0, 150+HORIZONTAL_TILE_SIZE_X*5, "SEOUL", 5000)
